(function () {
  ...
  let eA_top = "13%"; //Top-Position des Icons z.B. "200px" oder "calc(50% -44px)"
    ...
    function s() {
      ...
      if (co.length > 0) {
        ...
        let s =
          ...
          t2 +
          t3 +
          '" id="i" style="display: block; height: 50px !important; width: 50px !important; cursor: pointer;transition: transform 150ms ease;">' +
